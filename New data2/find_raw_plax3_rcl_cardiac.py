...
fid2=open('/media/ghazal/New Volume/raw_plax_paths4.txt','a+')
fid=open('/media/ghazal/New Volume/raw_plax_paths4_not_found.txt','r')
fid3=open('/media/ghazal/New Volume/raw_plax_paths4_not_found2.txt','w')
def find(s, ch):
...
for i in range(67854):
    ...
    #rcl_cardiac Echo:
    a=find_file_drive4(name,'/media/truecrypt4',folder)
    if a==0:
        # rcl_cardiac Echo2:
        a = find_file(name, '/media/truecrypt5', folder)
    if a==0:
        # rcl_cardiac Echo1:
